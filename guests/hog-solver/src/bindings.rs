...
pub unsafe fn _export_solve_cabi<T: Guest>(arg0: *mut u8, arg1: usize) -> *mut u8 {
    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
    let len0 = arg1;
    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
    let result1 = T::solve(_rt::string_lift(bytes0));
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_solve<T: Guest>(arg0: *mut u8) {
...
pub trait Guest {
    fn solve(input: _rt::String) -> Result<_rt::String, _rt::String>;
}
#[doc(hidden)]
macro_rules! __export_world_solver_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        const _ : () = { #[unsafe (export_name = "solve")] unsafe extern "C" fn
        export_solve(arg0 : * mut u8, arg1 : usize,) -> * mut u8 { unsafe {
        $($path_to_types)*:: _export_solve_cabi::<$ty > (arg0, arg1) } } #[unsafe
        (export_name = "cabi_post_solve")] unsafe extern "C" fn _post_return_solve(arg0 :
        * mut u8,) { unsafe { $($path_to_types)*:: __post_return_solve::<$ty > (arg0) } }
        };
    };
}
#[doc(hidden)]
